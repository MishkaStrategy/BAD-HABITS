...
For every non-trivial task in `MishkaStrategy/BAD-HABITS`, load the current `main` version of `MishkaStrategy/.github/AI_AGENT_POLICY.md` once for the current working session.
